    ...
    <form action="${url.loginAction}" method="post" class="space-y-6">
      ...
      <#if realm.resetPasswordAllowed>
        <div class="text-right">
          <a href="${url.forgotPasswordUrl!}" class="text-black underline hover:no-underline">
            Forgot your password?
          </a>
        </div>
      </#if>
      
      <!-- Sign In Button with solid-shadow-rectangle style -->
      <button 
        type="submit" 
      ...
      <#if realm.registrationAllowed>
        <div class="text-center mt-6">
          ...
          <a href="${url.registrationUrl}" class="text-black underline hover:no-underline">
            Register
          </a>
        </div>
      </#if>
