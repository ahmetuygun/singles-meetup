...
import { EntityArrayResponseType, UserEventService } from '../service/user-event.service';
import { UserEventDeleteDialogComponent } from '../delete/user-event-delete-dialog.component';
