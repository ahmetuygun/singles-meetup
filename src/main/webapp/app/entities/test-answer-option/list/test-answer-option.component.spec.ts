...
import { sampleWithRequiredData } from '../test-answer-option.test-samples';
...
describe('TestAnswerOption Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [TestAnswerOptionComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.testAnswerOptions()[0]).toEqual(expect.objectContaining({ id: 15811 }));
  });

  describe('trackId', () => {
    it('should forward to testAnswerOptionService', () => {
      const entity = { id: 15811 };
      jest.spyOn(service, 'getTestAnswerOptionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTestAnswerOptionIdentifier).toHaveBeenCalledWith(entity);
