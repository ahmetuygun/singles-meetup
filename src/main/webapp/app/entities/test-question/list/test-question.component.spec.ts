...
import { sampleWithRequiredData } from '../test-question.test-samples';
...
describe('TestQuestion Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.testQuestions()[0]).toEqual(expect.objectContaining({ id: 24178 }));
  });

  describe('trackId', () => {
    it('should forward to testQuestionService', () => {
      const entity = { id: 24178 };
      jest.spyOn(service, 'getTestQuestionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTestQuestionIdentifier).toHaveBeenCalledWith(entity);
