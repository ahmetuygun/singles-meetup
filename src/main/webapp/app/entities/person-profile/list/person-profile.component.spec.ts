...
import { sampleWithRequiredData } from '../person-profile.test-samples';
...
describe('PersonProfile Management Component', () => {
  let comp: PersonProfileComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PersonProfileComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.personProfiles()[0]).toEqual(expect.objectContaining({ id: 25470 }));
  });

  describe('trackId', () => {
    it('should forward to personProfileService', () => {
      const entity = { id: 25470 };
      jest.spyOn(service, 'getPersonProfileIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPersonProfileIdentifier).toHaveBeenCalledWith(entity);
